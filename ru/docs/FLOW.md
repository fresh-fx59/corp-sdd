...
Запустите семь скриптов из `tests/` для обоих языковых комплектов. Они проверяют синхронизацию
подмодулей, безопасность веток, агрегацию, индексацию, вычисление путей, объём документации,
резервный путь без MCP, явные вызовы `<openspec>`, штампы редакции комплекта с манифестом и
отсутствие старых путей клонов.
